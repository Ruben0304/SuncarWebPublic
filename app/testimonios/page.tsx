...
export default function TestimonialsPage() {
  ...
  useAOS({ duration: 500, once: true, offset: 50 });
  ...
  const videoTestimonials = [
    {
      ...
      description:
        "Experiencia real de instalación de paneles solares con SunCar",
    },
    {
      id: 2,
      ...
      thumbnail: "/placeholder.jpg",
      description:
        "Testimonio de cliente satisfecho con su instalación de energía solar",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Escucha directamente de nuestros clientes satisfechos sobre su
              experiencia con SunCar
            </p>
          </div>
