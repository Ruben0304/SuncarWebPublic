      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block px-4 py-2 lg:px-6 lg:py-3 bg-[#012928] text-white text-sm lg:text-base font-semibold rounded-full mb-6 animate-bounce">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="font-bold text-[#012928]"> rebajas sustanciales</span> en
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl transform animate-scale-in">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#012928] rounded-full flex items-center justify-center mx-auto mb-4">
