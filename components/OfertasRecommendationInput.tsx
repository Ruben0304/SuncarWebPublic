  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-8 md:mb-12 px-4">
      ...
      <div className="mb-6 md:mb-8 text-center" data-aos="fade-up">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#012928] leading-tight mb-3">
        ...
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-[#AFEB17]/5 px-4 py-2 rounded-full border border-blue-200">
          <Zap className="w-4 h-4 text-[#012928]" />
          <span className="text-sm font-medium text-[#012928]">Búsqueda inteligente con IA</span>
        </div>
      </div>
      ...
      {loading ? (
        <div className="relative" data-aos="fade-up" data-aos-delay="100">
          <div className="relative bg-gradient-to-r from-[#AFEB17]/5 via-[#F2C300]/5 to-[#AFEB17]/5 rounded-2xl border-2 border-[#AFEB17]/40 shadow-2xl overflow-hidden">
            {/* Animated Background */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent animate-shimmer"></div>

            {/* Progress Bar */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-[#AFEB17]/15">
              <div className="h-full bg-gradient-to-r from-[#AFEB17] to-[#F2C300] animate-progress"></div>
            </div>
            ...
            <div className="relative flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 md:p-8">
              ...
              <div className="flex-shrink-0">
                <div className="relative w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20">
                  {/* Pulsing rings */}
                  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#AFEB17] to-[#F2C300] animate-ping opacity-20"></div>
                  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#AFEB17] to-[#F2C300] animate-pulse opacity-30"></div>

                  {/* Main icon circle - SIN bounce */}
                  <div className="relative flex items-center justify-center w-full h-full rounded-full bg-gradient-to-r from-[#AFEB17] to-[#F2C300] shadow-lg">
                    <CurrentIcon className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white animate-fade-in" key={currentMessageIndex} />
                  </div>

                  {/* Spinner overlay */}
                  <div className="absolute -inset-2 sm:-inset-3">
                    <Loader2 className="w-full h-full text-[#AFEB17] animate-spin opacity-30" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 text-center sm:text-left w-full">
                <div className="flex items-center justify-center sm:justify-start gap-2 mb-2">
                  <div className="flex gap-1">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#AFEB17]/50 rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#AFEB17]/50 rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#AFEB17]/50 rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
                  </div>
                  <span className="text-xs sm:text-sm font-semibold text-[#012928] uppercase tracking-wider">
                    Procesando
                  </span>
                </div>

                <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-[#012928] mb-1 animate-fade-in px-2 sm:px-0" key={`text-${currentMessageIndex}`}>
                  {currentMessage.text}
                </h3>
                  ...
                  {LOADING_MESSAGES.map((_, index) => (
                    <div
                      ...
                      className={`h-1 sm:h-1.5 rounded-full transition-all duration-500 ${index === currentMessageIndex
                        ? 'w-6 sm:w-8 bg-gradient-to-r from-[#AFEB17] to-[#F2C300]'
                        : 'w-1 sm:w-1.5 bg-[#AFEB17]/20'
                        }`}
                    />
                  ))}
                </div>
              ...
              <div className="absolute top-2 right-2 hidden sm:block">
                <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-[#AFEB17] animate-pulse" />
              </div>
        ...
        <div className="relative" data-aos="fade-up" data-aos-delay="100">
          <form onSubmit={handleSubmit}>
            <div className={`relative bg-white rounded-2xl border-2 transition-all duration-500 shadow-lg hover:shadow-xl ${isExpanded
              ? 'border-[#AFEB17]/40 shadow-[#AFEB17]/15'
              : 'border-gray-200 hover:border-[#AFEB17]/25'
              }`}>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-6">
                <div className="flex-shrink-0 hidden sm:block">
                  <div className={`flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full transition-all duration-300 ${isExpanded
                    ? 'bg-gradient-to-r from-[#AFEB17] to-[#F2C300] scale-110'
                    : 'bg-gray-100'
                    }`}>
                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0 mr-3 sm:hidden">
                      <div className={`flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 ${isExpanded
                        ? 'bg-gradient-to-r from-[#AFEB17] to-[#F2C300]'
                        : 'bg-gray-100'
                        }`}>
