            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col">
                  <span className="text-lg lg:text-xl font-bold text-white drop-shadow-lg font-[family-name:var(--font-cinzel)]">
                    SUNCAR
                  </span>
                  <span className="text-[10px] text-red-200 font-semibold tracking-wide">
                    🎄 Feliz Navidad 🎄
                  </span>
                </div>
              </div>
